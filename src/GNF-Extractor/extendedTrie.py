...
# modified for rules with adjacent non-terminals
# all possible spliting points are considered
...
class SuffixTreeNode(object):
    ...
    def dfSearch(self, root_node, wLst):
        ...
        while len(dfsStack) > 0:
            ...
            if search_label != "$$$" and (curr_node.__childIndxDict.has_key("X__1") or curr_node.__childIndxDict.has_key("X__2")):   #TO-DO: it may have more than two non-terminal
