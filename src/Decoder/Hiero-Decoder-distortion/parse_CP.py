...
#                print "\nSpan:", p_i, p_j, "\tSpan length:", p_l + 1
    ...
    def __reduceCell(self, span, cell_type, rule_nt, final_cell):
        ...
        for conseq_obj in consObjsLst:
            ...
            ruleRHSLst = self.__getRulesFromPT(rule, span, conseq_obj.spanTup)
    ...
    def __getRulesFromPT(self, s_rule, span, spanLst=()):
        ...
        for rule_entry in tgtLst:
            ...
            new_entry = Entry.expandEntry(rule_entry, new_entry, span, spanLst)
