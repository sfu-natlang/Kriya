...
# modified for rules with more than two non-terminals
# (it is for at most 4 non-terminals right now
...
class SuffixTreeNode(object):
    ...
    def dfSearch(self, root_node, wLst):
        ...
        while len(dfsStack) > 0:
            ...
            if search_label != "$$$" and (curr_node.__childIndxDict.has_key("X__1") or curr_node.__childIndxDict.has_key("X__2")  or curr_node.__childIndxDict.has_key("X__3")  or curr_node.__childIndxDict.has_key("X__4")):
